...
function HomeTab({ totalAppointments, approved, cancelled, appointments, allDoctors, allServices }) {
  const completedAppointments = appointments.filter((a) => a.status === "completed");
  const totalRevenue = completedAppointments.reduce((sum, a) => sum + a.doctor.fees, 0);
...
function AllDoctorsTab({ doctors, onRemove, onToggleAvailability }) {
  return (
    <div>
...
function AddDoctorTab({ onAdd, onDone }) {
...
function AllServicesTab({ services, onRemove, onToggleAvailability }) {
  return (
    <div>
...
function AddServiceTab({ onAdd, onDone }) {
